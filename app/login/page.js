...
export default function Login() {
  ...
  const handleFacebookLogin = async () => {
    try {
      ...
      Swal.fire({
        icon: "success",
        title: "ล็อกอินสำเร็จ!",
        text: "คุณได้ล็อกอินด้วย Facebook แล้ว",
        showConfirmButton: false,
        timer: 1500,
      });
  ...
  const handleLineLogin = async () => {
    try {
      ...
      Swal.fire({
        icon: "success",
        title: "ล็อกอินสำเร็จ!",
        text: "คุณได้ล็อกอินด้วย Line แล้ว",
        showConfirmButton: false,
        timer: 1500,
      });
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 relative overflow-hidden">
          ...
          <div className="grid grid-cols-12 gap-4 w-full h-full p-8">
            {Array(48)
              ...
              .map((_, i) => (
                <div
                  key={i}
                  className="bg-white rounded-lg transform rotate-3"
                ></div>
              ))}
          </div>
        </div>
      ...
      <div className="m-4 max-w-md w-full p-8 bg-white bg-opacity-90 backdrop-blur-sm rounded-xl shadow-2xl z-10 border border-white border-opacity-20">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full flex items-center justify-center py-2 px-4 border border-blue-600 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-medium transition-all duration-200 shadow-md transform hover:-translate-y-0.5"
          >
            <svg
          ...
          {/* ปุ่มล็อกอินด้วย Line */}
          <button
            onClick={handleLineLogin}
            className="w-full flex items-center justify-center py-2 px-4 border border-green-500 rounded-lg bg-green-500 hover:bg-green-600 text-white font-medium transition-all duration-200 shadow-md transform hover:-translate-y-0.5"
          >
            <svg
              className="h-5 w-5 mr-2"
              fill="currentColor"
