      ...
      <div className="flex-1 p-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            <h2 className="text-xl font-bold text-gray-800 mb-4">การดำเนินการล่าสุด</h2>
              ...
              {[1, 2, 3].map((item) => (
                <div key={item} className="flex items-center p-3 border border-gray-100 rounded-lg hover:bg-gray-50">
                  ...
                  <div className="flex-1">
                    <p className="font-medium text-gray-800">การอัปเดตระบบ #{item}</p>
                    <p className="text-sm text-gray-500">เมื่อ 2 ชั่วโมงที่แล้ว</p>
                  </div>
                  <span className="px-2 py-1 bg-blue-100 text-blue-800 rounded text-xs">ดำเนินการแล้ว</span>
                </div>
              ))}
            </div>
          </div>
